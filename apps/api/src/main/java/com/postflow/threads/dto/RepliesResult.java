 ...
 */
public record RepliesResult(boolean available, List<ThreadsReply> replies, String debug) {
    public static RepliesResult ok(List<ThreadsReply> replies) {
        return new RepliesResult(true, replies, null);
    }

    public static RepliesResult unavailable() {
        return new RepliesResult(false, List.of(), null);
    }

    public static RepliesResult unavailable(String debug) {
        return new RepliesResult(false, List.of(), debug);
    }
}
